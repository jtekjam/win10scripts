...
Function InstallJtekProgs {
	...
	Start-BitsTransfer -Source "https://raw.githubusercontent.com/jtekjam/win10script/master/ooshutup10.cfg" -Destination ooshutup10.cfg
...
Function NetworkTeaks {
	Write-Output "Running Network Tweaks..."
